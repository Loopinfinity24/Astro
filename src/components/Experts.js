                ...
                <div class="card text-center expert-card">
                  <div class="card-body">
                    <img
                      ...
                      alt="..."
                    />
                    <h5 class="card-title py-3">Vipin Kapoor</h5>
                ...
                <div class="card text-center expert-card">
                  <div class="card-body">
                    <img
                      ...
                      alt="..."
                    />
                    <h5 class="card-title py-3">Prashant Kapoor</h5>
                    <p class="card-text">Astrologer</p>
                  </div>
                </div>
              </div>
                ...
                <div class="card text-center expert-card">
                  <div class="card-body">
                    <img
                      ...
                      alt="..."
                    />
                    <h5 class="card-title py-3">Dr. Satarupa Bhattacharjee</h5>
                ...
                <div class="card text-center expert-card">
                  <div class="card-body">
                    <img
                      ...
                      alt="..."
                    />
                    <h5 class="card-title py-3">Akanksha Srivastava</h5>
