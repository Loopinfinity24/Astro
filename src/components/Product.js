  ...
  return (
    <>
      ...
      <Helmet>
                ...
                <title>{oneposts[0] ? oneposts[0].seotitle : ''}</title>
       ...
       <Breadcrumb className="header_text2" style={{float:'right',marginRight:'50%',height:'100px',marginTop:'-106px',fontSize:'23px'}}>
         ...
         <Breadcrumb.Item href="/product" style={{color:'#f59042'}}>Products </Breadcrumb.Item>
         <Breadcrumb>
...
<button type="button" class="btn btn-secondary">Submit</button>
          ...
          <div className="col-md-8" >
            <img src={oneposts[0] ? oneposts[0].Imageurl : ''} alt="blog1" className="blog1" />
            <h1 className="blogHeading">{oneposts[0] ? oneposts[0].productname : ''}</h1>
            <div className="social" style={{ justifyContent: 'flex-start', marginBottom: '2%', marginTop: '3%' }}>
              <div className="calendar">
                <img src={calendar} alt="calendar" />
                <Card.Text style={{ color: 'blue' }} className="blog_content">{oneposts[0] ? getDate(oneposts[0].createdAt) : ''}</Card.Text>
              </div>
