            ...
            <div>
              <Card style={{ width: '29rem', height: '29rem', marginBottom: '20px' }}>
                ...
                <Card.Body>
                  ...
                  <div className="social">
                    <Button variant="primary" className="blog_read_more" style={{ color:'#ff7e00 !important' }}><a href={"/blogs/" + post.id} style={{ color: 'white', fontSize: '.8rem',background:'#ff7e00 !important' }}>Explore</a></Button>
                    <div className="icon">
