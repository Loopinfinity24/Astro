  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <span className="header_text1">Blogs</span>
       ...
       <Breadcrumb className="header_text2" style={{float:'right',marginRight:'50%',height:'100px',marginTop:'-106px',fontSize:'23px'}}>
         ...
         <Breadcrumb.Item href="/blogs" style={{color:'#f59042'}}>Blogs </Breadcrumb.Item>
         <Breadcrumb>
...
<button type="button" class="btn btn-secondary">Submit</button>
          ...
          <div className="col-md-8" >
            ...
            <h1 className="blogHeading">{oneposts[0] ? oneposts[0].desgin_type : ''}</h1>
            ...
            {oneposts[0] ? <div dangerouslySetInnerHTML={{ __html: oneposts[0].desgin_des }}></div> : ''}
